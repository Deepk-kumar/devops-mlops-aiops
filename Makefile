...
.PHONY: help infra-init infra-apply infra-destroy k3s-remote k3s tf-init tf-plan tf-apply tf-destroy status argocd-password argocd-ui minio-ui data train test deploy-app api-forward api-test
